			...
			<Container customClasses="flex flex-col lg:items-end lg:justify-end lg:absolute lg:left-1/2 lg:-translate-x-1/2">
				<div className="flex justify-end flex-col lg:items-end lg:max-w-md xl:max-w-2xl 2xl:max-w-4xl">
					<div className="flex flex-col max-w-4xl lg:text-right">
						<h2 className="font-bold text-6xl pb-6">Contáctanos</h2>
						<p>
							Y tráenos una bebida si estás cerca.<br></br>Envíanos un aorreo a {" "}
							<a className="text-yellow-btn-primary underline underline-offset-4 hover:text-yellow-600" href="mailto:hello@udg.mx" target="_blank" rel="noreferrer">
								{" "}
								hello@udg.mx{" "}
							</a>{" "}
